...
## HU01 – Selecionar tipo de profissional 
...
## HU04 – Utilizar endereço cadastrado (HU05)
...
### Critérios de Aceite
* Dado que possuo um endereço cadastrado
* Quando confirmar o agendamento
* Então o endereço deve ser associado automaticamente à consulta.

## HU05 – Selecionar profissional para exame (HU06)
...
* Prioridade: Should Have
### Critérios de Aceite
#### Cenário 1 – Exame solicitado
* Dado que o paciente está cadastrado
...
* Prioridade: Must Have
### Critérios de Aceite
#### Cenário 1 – Lista exibida
* Dado que existem consultas cadastradas
...
* Prioridade: Must Have
### Critérios de Aceite
#### Cenário 1 – Exames exibidos
* Dado que existem exames registrados
* Quando acessar a lista
...
* Prioridade: Should Have
### Critérios de Aceite
#### Cenário 1 – Remarcação concluída
* Dado que a consulta existe
...
* Prioridade: Should Have
### Critérios de Aceite
#### Cenário 1 – Exame remarcado
* Dado que o exame existe
...
* Prioridade: Must Have
### Critérios de Aceite
#### Cenário 1 – Cancelamento realizado
...
## HU017 – Disponibilizar agenda (HU018)
...
* Prioridade: Must Have
### Critérios de Aceite
#### Cenário 1 – Agenda publicada
* Dado que estou autenticado como profissional
...
* Quando o usuario preencher todos os dados obrigatórios corretamente e confirmar o cadastro
...
E exibir uma mensagem informando que as credenciais são inválidas.
